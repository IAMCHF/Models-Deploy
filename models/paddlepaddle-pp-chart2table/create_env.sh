...
# 模型: PaddlePaddle/PP-Chart2Table
# 策略: PaddlePaddle + PaddleX 模型
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: paddlepaddle-pp-chart2table"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: PaddlePaddle/PP-Chart2Table"
    echo "folder_name: paddlepaddle-pp-chart2table"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: paddlepaddle-pp-chart2table"
