...
# 模型: OpenMOSS-Team/MOSS-VoiceGenerator
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: openmoss-team-moss-voicegenerator"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: OpenMOSS-Team/MOSS-VoiceGenerator"
    echo "folder_name: openmoss-team-moss-voicegenerator"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: openmoss-team-moss-voicegenerator"
