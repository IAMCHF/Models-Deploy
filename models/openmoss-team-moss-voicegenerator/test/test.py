...
# -*- coding: utf-8 -*-
"""
测试脚本 - openmoss-team-moss-voicegenerator
- /health 断言 status=ok
- /predict 契约: 输入=JSON {text, instruction}(base64), 输出=合成语音WAV
...
logger = logging.getLogger("test_openmoss-team-moss-voicegenerator")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: openmoss-team-moss-voicegenerator @ %s", BASE_URL)
    logger.info("=" * 50)
    try:
        test_health()
