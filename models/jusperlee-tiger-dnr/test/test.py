...
# -*- coding: utf-8 -*-
"""
测试脚本 - jusperlee-tiger-dnr
- /health 断言 status=ok
- /predict 契约: 输入=44.1kHz 人声+音乐混合WAV(base64), 输出=3声道分离WAV(人声/音效/音乐)
...
logger = logging.getLogger("test_jusperlee-tiger-dnr")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: jusperlee-tiger-dnr @ %s", BASE_URL)
    logger.info("=" * 50)
    try:
        test_health()
