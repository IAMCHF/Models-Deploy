...
echo "=========================================="
echo "[env] 开始创建虚拟环境: jusperlee-tiger-dnr"
echo "=========================================="
...
# 4. 如需覆盖基础版本，先卸载旧版本
# ------------------------------------------------------------
echo "[env] 卸载基础镜像默认版本: torch torchaudio torchvision transformers"
...
echo "[env] 记录环境信息"
{
    echo "model_id: JusperLee/TIGER-DnR"
    echo "folder_name: jusperlee-tiger-dnr"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: jusperlee-tiger-dnr"
