...
# 模型: PaddlePaddle/PP-OCRv6_small_det_onnx
# 策略: 使用基础镜像默认环境
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: paddlepaddle-pp-ocrv6-small-det-onnx"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: PaddlePaddle/PP-OCRv6_small_det_onnx"
    echo "folder_name: paddlepaddle-pp-ocrv6-small-det-onnx"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: paddlepaddle-pp-ocrv6-small-det-onnx"
