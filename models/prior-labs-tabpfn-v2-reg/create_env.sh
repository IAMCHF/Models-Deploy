...
echo "=========================================="
echo "[env] 开始创建虚拟环境: prior-labs-tabpfn-v2-reg"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: Prior-Labs/TabPFN-v2-reg"
    echo "folder_name: prior-labs-tabpfn-v2-reg"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: prior-labs-tabpfn-v2-reg"
