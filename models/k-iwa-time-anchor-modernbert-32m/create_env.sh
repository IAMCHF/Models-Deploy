...
# 模型: K-Iwa/time-anchor-modernbert-32m
# 策略: 使用基础镜像默认环境
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: k-iwa-time-anchor-modernbert-32m"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: K-Iwa/time-anchor-modernbert-32m"
    echo "folder_name: k-iwa-time-anchor-modernbert-32m"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: k-iwa-time-anchor-modernbert-32m"
