...
echo "=========================================="
echo "[env] 开始创建虚拟环境: opengvlab-videomaev2-base"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: OpenGVLab/VideoMAEv2-Base"
    echo "folder_name: opengvlab-videomaev2-base"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: opengvlab-videomaev2-base"
