...
# -*- coding: utf-8 -*-
"""
测试脚本 - facebook-vjepa2-vitl-fpc64-256
...
logger = logging.getLogger("test_facebook-vjepa2-vitl-fpc64-256")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: facebook-vjepa2-vitl-fpc64-256 @ %s", BASE_URL)
    logger.info("=" * 50)
