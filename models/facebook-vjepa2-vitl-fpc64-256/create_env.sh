...
echo "=========================================="
echo "[env] 开始创建虚拟环境: facebook-vjepa2-vitl-fpc64-256"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: facebook/vjepa2-vitl-fpc64-256"
    echo "folder_name: facebook-vjepa2-vitl-fpc64-256"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: facebook-vjepa2-vitl-fpc64-256"
