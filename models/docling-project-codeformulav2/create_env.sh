...
# 模型: docling-project/CodeFormulaV2
# 策略: CodeFormulaV2：需 Docling 框架 + ONNX 推理
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: docling-project-codeformulav2"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: docling-project/CodeFormulaV2"
    echo "folder_name: docling-project-codeformulav2"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: docling-project-codeformulav2"
