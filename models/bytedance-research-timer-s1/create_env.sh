...
# 策略: Timer-S1：锁定特定 transformers 版本
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: bytedance-research-timer-s1"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: bytedance-research/Timer-S1"
    echo "folder_name: bytedance-research-timer-s1"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: bytedance-research-timer-s1"
