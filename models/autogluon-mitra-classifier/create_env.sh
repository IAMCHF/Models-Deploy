...
echo "=========================================="
echo "[env] 开始创建虚拟环境: autogluon-mitra-classifier"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: autogluon/mitra-classifier"
    echo "folder_name: autogluon-mitra-classifier"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: autogluon-mitra-classifier"
