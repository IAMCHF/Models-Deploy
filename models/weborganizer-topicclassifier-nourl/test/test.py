...
# -*- coding: utf-8 -*-
"""
测试脚本 - weborganizer-topicclassifier-nourl
...
logger = logging.getLogger("test_weborganizer-topicclassifier-nourl")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: weborganizer-topicclassifier-nourl @ %s", BASE_URL)
    logger.info("=" * 50)
