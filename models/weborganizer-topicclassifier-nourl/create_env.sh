...
# 模型: WebOrganizer/TopicClassifier-NoURL
# 策略: 使用基础镜像默认环境
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: weborganizer-topicclassifier-nourl"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: WebOrganizer/TopicClassifier-NoURL"
    echo "folder_name: weborganizer-topicclassifier-nourl"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: weborganizer-topicclassifier-nourl"
