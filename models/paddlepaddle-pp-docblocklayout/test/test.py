...
# -*- coding: utf-8 -*-
"""
测试脚本 - paddlepaddle-pp-docblocklayout
- /health 断言 status=ok
...
logger = logging.getLogger("test_paddlepaddle-pp-docblocklayout")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: paddlepaddle-pp-docblocklayout @ %s", BASE_URL)
    logger.info("=" * 50)
    try:
        test_health()
