...
# 模型: PaddlePaddle/PP-DocBlockLayout
# 策略: PaddlePaddle 模型
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: paddlepaddle-pp-docblocklayout"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: PaddlePaddle/PP-DocBlockLayout"
    echo "folder_name: paddlepaddle-pp-docblocklayout"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: paddlepaddle-pp-docblocklayout"
