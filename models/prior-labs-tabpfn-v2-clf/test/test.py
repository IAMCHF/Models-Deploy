...
# -*- coding: utf-8 -*-
"""
测试脚本 - prior-labs-tabpfn-v2-clf
- /health 断言 status=ok
- /predict 契约: 输入=JSON {X_train, y_train, X_test}(base64 文件原文), 输出=JSON {predictions, probabilities}
...
logger = logging.getLogger("test_prior-labs-tabpfn-v2-clf")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: prior-labs-tabpfn-v2-clf @ %s", BASE_URL)
    logger.info("=" * 50)
    try:
        test_health()
