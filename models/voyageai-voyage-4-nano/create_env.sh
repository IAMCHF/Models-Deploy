...
echo "=========================================="
echo "[env] 开始创建虚拟环境: voyageai-voyage-4-nano"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: voyageai/voyage-4-nano"
    echo "folder_name: voyageai-voyage-4-nano"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: voyageai-voyage-4-nano"
