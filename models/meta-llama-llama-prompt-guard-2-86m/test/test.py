...
# -*- coding: utf-8 -*-
"""
测试脚本 - meta-llama-llama-prompt-guard-2-86m
...
logger = logging.getLogger("test_meta-llama-llama-prompt-guard-2-86m")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: meta-llama-llama-prompt-guard-2-86m @ %s", BASE_URL)
    logger.info("=" * 50)
