...
# 模型: meta-llama/Llama-Prompt-Guard-2-86M
# 策略: 使用基础镜像默认环境
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: meta-llama-llama-prompt-guard-2-86m"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: meta-llama/Llama-Prompt-Guard-2-86M"
    echo "folder_name: meta-llama-llama-prompt-guard-2-86m"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: meta-llama-llama-prompt-guard-2-86m"
