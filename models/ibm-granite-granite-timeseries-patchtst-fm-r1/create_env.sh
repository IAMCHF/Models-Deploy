...
# 模型: ibm-granite/granite-timeseries-patchtst-fm-r1
# 策略: 使用基础镜像默认环境
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: ibm-granite-granite-timeseries-patchtst-fm-r1"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: ibm-granite/granite-timeseries-patchtst-fm-r1"
    echo "folder_name: ibm-granite-granite-timeseries-patchtst-fm-r1"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: ibm-granite-granite-timeseries-patchtst-fm-r1"
