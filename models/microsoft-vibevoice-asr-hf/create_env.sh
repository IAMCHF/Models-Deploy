...
# 模型: microsoft/VibeVoice-ASR-HF
# 策略: VibeVoice-ASR：需 transformers 5.x
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: microsoft-vibevoice-asr-hf"
echo "=========================================="
...
# 4. 如需覆盖基础版本，先卸载旧版本
# ------------------------------------------------------------
echo "[env] 卸载基础镜像默认版本: transformers"
...
echo "[env] 记录环境信息"
{
    echo "model_id: microsoft/VibeVoice-ASR-HF"
    echo "folder_name: microsoft-vibevoice-asr-hf"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: microsoft-vibevoice-asr-hf"
