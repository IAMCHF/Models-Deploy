...
# -*- coding: utf-8 -*-
"""
测试脚本 - microsoft-vibevoice-asr-hf
- /health 断言 status=ok
- /predict 契约: 输入=语音WAV(base64), 输出=转写文本
...
logger = logging.getLogger("test_microsoft-vibevoice-asr-hf")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: microsoft-vibevoice-asr-hf @ %s", BASE_URL)
    logger.info("=" * 50)
    try:
        test_health()
