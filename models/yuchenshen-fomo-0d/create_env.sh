...
# 模型: YuchenShen/FoMo-0D
# 策略: FoMo-0D：需额外框架 + 本地仓库代码
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: yuchenshen-fomo-0d"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: YuchenShen/FoMo-0D"
    echo "folder_name: yuchenshen-fomo-0d"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: yuchenshen-fomo-0d"
