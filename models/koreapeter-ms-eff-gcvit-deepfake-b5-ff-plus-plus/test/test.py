...
# -*- coding: utf-8 -*-
"""
测试脚本 - koreapeter-ms-eff-gcvit-deepfake-b5-ff-plus-plus
- /health 断言 status=ok
...
logger = logging.getLogger("test_koreapeter-ms-eff-gcvit-deepfake-b5-ff-plus-plus")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: koreapeter-ms-eff-gcvit-deepfake-b5-ff-plus-plus @ %s", BASE_URL)
    logger.info("=" * 50)
    try:
        test_health()
