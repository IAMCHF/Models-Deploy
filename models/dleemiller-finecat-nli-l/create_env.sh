...
echo "=========================================="
echo "[env] 开始创建虚拟环境: dleemiller-finecat-nli-l"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: dleemiller/finecat-nli-l"
    echo "folder_name: dleemiller-finecat-nli-l"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: dleemiller-finecat-nli-l"
