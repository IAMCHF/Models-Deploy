...
# 模型: google/videoprism-lvt-base-f16r288
# 策略: VideoPrism：需 JAX 框架而非 PyTorch
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: google-videoprism-lvt-base-f16r288"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: google/videoprism-lvt-base-f16r288"
    echo "folder_name: google-videoprism-lvt-base-f16r288"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: google-videoprism-lvt-base-f16r288"
