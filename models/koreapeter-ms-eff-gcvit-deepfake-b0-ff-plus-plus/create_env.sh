...
# 模型: KoreaPeter/ms-eff-gcvit-deepfake-b0-ff-plus-plus
# 策略: 使用基础镜像默认环境
# ============================================================
set -e
...
echo "=========================================="
echo "[env] 开始创建虚拟环境: koreapeter-ms-eff-gcvit-deepfake-b0-ff-plus-plus"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: KoreaPeter/ms-eff-gcvit-deepfake-b0-ff-plus-plus"
    echo "folder_name: koreapeter-ms-eff-gcvit-deepfake-b0-ff-plus-plus"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: koreapeter-ms-eff-gcvit-deepfake-b0-ff-plus-plus"
