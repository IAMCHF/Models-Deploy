...
# -*- coding: utf-8 -*-
"""
FastAPI 服务 - KoreaPeter/ms-eff-gcvit-deepfake-b0-ff-plus-plus
任务: 深度伪造检测(Fast,224x224)
模态: image

模型卡来源: https://hf-mirror.com/KoreaPeter/ms-eff-gcvit-deepfake-b0-ff-plus-plus
...
logger = logging.getLogger("koreapeter-ms-eff-gcvit-deepfake-b0-ff-plus-plus")

WEIGHTS_DIR = Path(__file__).resolve().parent / "weights"
MODEL_ID = "KoreaPeter/ms-eff-gcvit-deepfake-b0-ff-plus-plus"

app = FastAPI(title="koreapeter-ms-eff-gcvit-deepfake-b0-ff-plus-plus", version="1.0.0")

# ============================================================
# 模型加载区域 — transformers image-classification pipeline (来自模型卡 Model Usage)
# 参考: https://hf-mirror.com/KoreaPeter/ms-eff-gcvit-deepfake-b0-ff-plus-plus
...
def load_model():
    """加载 MS-EffGCViT 深度伪造检测 pipeline (image-classification)"""
    global clf, _device
    if clf is not None:
        return
    try:
    ...
    logger.info("MS-EffGCViT-b0 pipeline 加载完成")
