...
# -*- coding: utf-8 -*-
"""
测试脚本 - alibaba-nlp-gte-modernbert-base
...
logger = logging.getLogger("test_alibaba-nlp-gte-modernbert-base")
...
def main():
    logger.info("=" * 50)
    logger.info("开始测试: alibaba-nlp-gte-modernbert-base @ %s", BASE_URL)
    logger.info("=" * 50)
