...
echo "=========================================="
echo "[env] 开始创建虚拟环境: alibaba-nlp-gte-modernbert-base"
echo "=========================================="
...
echo "[env] 记录环境信息"
{
    echo "model_id: Alibaba-NLP/gte-modernbert-base"
    echo "folder_name: alibaba-nlp-gte-modernbert-base"
...
echo "=========================================="
echo "[env] 虚拟环境创建完成: alibaba-nlp-gte-modernbert-base"
