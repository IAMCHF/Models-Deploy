# 重测 12 个修复后的 FAIL 模型 (与全量同形态: --network none + bash start.sh)
...
$MODELS = [ordered]@{
  ...
  "bytedance-research-timer-s1"                     = 150
  "dleemiller-finecat-nli-l"                        = 25
  "docling-project-codeformulav2"                   = 25
  "ibm-research-ttm-r3"                             = 10
...
Write-Result "========================================"
Write-Result "Retest fixed 12 - $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') (offline, --network none)"
Write-Result "========================================"
...
Write-Result "========================================"
Write-Result "Retest12 Summary: PASS $passCount / FAIL $failCount / TOTAL $($MODELS.Count)"
if ($failList.Count -gt 0) { Write-Result "Retest12 Failed: $($failList -join ', ')" }
Write-Result "========================================"
